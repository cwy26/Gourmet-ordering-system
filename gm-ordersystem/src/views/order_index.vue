...
/* 解决父元素高度坍塌 */
.order_index .floor1 .top_fixed:after,
.top_more_showMore:after {
  display: block;
  content: "";
  clear: both;
}
...
.order_index .floor1 .top_fixed .top_more .top_more_showMore li:nth-child(2),
.order_index .floor1 .top_fixed .top_more .top_more_showMore li:nth-child(3) {
  padding: 0px;
  margin: 0px;
  margin-bottom: 10px;
}
...
.order_index .floor3 .left_btns,
.order_index .floor3 .right_btns {
